...
public class BlockScanner extends Scanner {
    ...
    public float averageTemperature() {
        return mBiomeTemperatureSum / mVolume;
    }

    public float averageHumidity() {
        return mBiomeHumiditySum / mVolume;
    }

    public float averageSalinity() {
        return mBiomeSalinity / mVolume;
    }

    public float averageSunLevel() {
        return mAverageSunLevel / mVolume;
    }

    public int biomeTagCount(BiomeDictionary.Type type) {
        return mBiomeTagCounts.get(type);
    }
